...
contract RLN {
    ...
    constructor(
        ...
        ezklverifier=iezkl(_ezklverifier);
    }
    ...
    function verify_ezkl(uint256[7] calldata instances, bytes calldata proof) external{
        ezkl=ezklverifier.verify([instances[0], instances[1],
            instances[2], instances[3], instances[4], instances[5],
            instances[6]],proof);
    }
